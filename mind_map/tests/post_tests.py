...
class ClientTest(unittest.TestCase):
    """For the tests to pass, make sure BASE_URL is set correctly to your Docker container IP address (or export APP_BASE_URL from the environment) and delete (or move) the app.db database (run.sh will recreate it)"""
